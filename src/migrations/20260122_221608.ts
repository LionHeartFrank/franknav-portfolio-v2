...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "settings_nav_items_locales" (
  	"label" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "settings_locales" (
  	"site_title" varchar DEFAULT 'Frank Nav Portfolio',
  	"description" varchar DEFAULT 'UX/UI Designer & Junior FullStack Developer',
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  ALTER TABLE "settings_nav_items_locales" ADD CONSTRAINT "settings_nav_items_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."settings_nav_items"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "settings_nav_items_locales_locale_parent_id_unique" ON "settings_nav_items_locales" USING btree ("_locale","_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "settings_nav_items_locales" CASCADE;
