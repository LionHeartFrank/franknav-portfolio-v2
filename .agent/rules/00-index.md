...
| File Name | Description | Scope | Origin | Activation Mode | Command / Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
| [`admin-ui-guide.md`](../workflows/admin-ui-guide.md) | Admin UI Documentation Workflow. | Admin UI | User | Model Decision | `/admin-ui-guide` |
| [`communication.md`](../workflows/communication.md) | Project Management & Communication Workflow. | Core / General | User | Model Decision | `/communication` |
| [`git.md`](../workflows/git.md) | Git Workflow for Atomic Development and Feature Branches. | Core / General | User | Model Decision | `/git` |
| [`pnpm-only.md`](../workflows/pnpm-only.md) | pnpm-Only Package Management Workflow. | Core / General | User | Model Decision | `/pnpm-only` |
| [`types-generate-types-with-pnpm-payload.md`](../workflows/types-generate-types-with-pnpm-payload.md) | Ironclad Type Generation Workflow. | Database / Schema | User | Model Decision | `/types-generate-types-with-pnpm-payload` |
